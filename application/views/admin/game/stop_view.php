      ...
      <div class="row-fluid">
		<div class="row">
            <div class="span12">
              ...
              <p class="pull-right">
                <a href="<?php echo base_url('admin/application/stop'); ?>" class="btn btn-large">Hiện tất cả</a>
              ...
              <script type="text/javascript">
                $(document).ready(function() {                  
                  $('#filter').on('click', function(){          
                     ...
                     window.location.href   = "<?php echo base_url('admin/application/stop'); ?>?lang=" + $('#slLang').val();
